...
- source_spec: none
  ...
  evidence: Separado do Epic 1 completo para manter o foco na criação do esqueleto visual primeiro.
- source_spec: `_bmad-output/implementation-artifacts/archive/epic-1/spec-1-1-esqueleto-visual-barra-navegacao.md`
...
- source_spec: `_bmad-output/implementation-artifacts/archive/epic-1/spec-1-4-encerrar-sessao.md`
...
- source_spec: `_bmad-output/implementation-artifacts/archive/epic-1/spec-1-4-correcao-botao-sair.md`
...
- source_spec: `_bmad-output/implementation-artifacts/archive/epic-1/spec-1-3-protecao-de-sessao-e-isolamento-de-dados.md`
...
- source_spec: `_bmad-output/implementation-artifacts/archive/epic-1/spec-correcao-navbar-e-logout.md`
...
- source_spec: `_bmad-output/implementation-artifacts/archive/epic-1/spec-header-transparente-flutuante.md`
...
- source_spec: `_bmad-output/implementation-artifacts/archive/epic-1/spec-correcao-uso-tailwind.md`
...
- source_spec: `_bmad-output/implementation-artifacts/archive/epic-1/spec-correcao-uso-tailwind.md`
  ...
  evidence: Surfaced by blind-hunter review.
- source_spec: `/home/guilhermepagio/developer/workspace/projeto-aureus/_bmad-output/implementation-artifacts/archive/epic-2/spec-2-1-gestao-de-contas-crud-com-protecao-de-vinculo.md`
...
- source_spec: `_bmad-output/implementation-artifacts/archive/epic-2/spec-2-2-gestao-de-categorias-crud-com-protecao-de-vinculo.md`
...
- source_spec: `/home/guilhermepagio/developer/workspace/projeto-aureus/_bmad-output/implementation-artifacts/archive/epic-2/spec-2-3-restricao-granular-de-cadastro-sem-dependencias.md`
...
- source_spec: `_bmad-output/implementation-artifacts/archive/epic-3/spec-3-1-lancamentos-fixos-despesas-e-receitas-com-vigencia.md`
...
- source_spec: `/home/guilhermepagio/developer/workspace/projeto-aureus/_bmad-output/implementation-artifacts/archive/epic-3/spec-3-2-lancamentos-variaveis-e-parcelados-com-arredondamento-de-centavos.md`
...
- source_spec: `_bmad-output/implementation-artifacts/archive/epic-3/spec-3-4-sincronizacao-de-visao-mensal-invalidacao-de-cache-e-filtro.md`
...
## Deferred from: code review (spec-4-3-bloco-analitico-de-categorias.md)
- Fetches all transactions regardless of requested period: Unfiltered Database Fetch fetches all transactions without date filtering at DB level.
- Hardcoded 24-month horizon magic numbers: Magic numbers used across frontend and backend.
- Raw fetch and manual CSRF token instead of centralized client: Hook bypasses standard API clients.

## Deferred from: code review of spec-4-3-bloco-analitico-de-categorias.md (2026-09-05)

- Inefficient in-memory filtering for DespesaVariavel in ConsolidacaoService [ConsolidacaoService.java:165] — pre-existing query pattern across consolidacao services.

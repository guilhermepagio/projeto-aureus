      ...
      {action && (
        <div className="mt-6">
          <button
            ...
            type="button"
            className={`cursor-pointer inline-flex items-center rounded-md px-3 py-1 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ${buttonColorClass}`}
          >
            {action.label}
          </button>
        </div>

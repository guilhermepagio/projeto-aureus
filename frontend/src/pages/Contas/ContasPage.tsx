          ...
          <table className="min-w-max w-full divide-y divide-gray-200 table-fixed">
            <thead className="bg-gray-50 sticky top-0 z-10 shadow-sm">
              <tr>
                ...
                <th scope="col" className="px-6 py-1 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider min-w-[300px]">
                  Observações
                </th>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {contas.map((conta) => (
                <tr key={conta.id} className="group even:bg-gray-200 odd:bg-white text-sm">

...
import { useDeleteReceitaVariavel, type ReceitaVariavel } from '../../../hooks/useReceitasVariaveis';

interface DeleteConfirmModalProps {
  isOpen: boolean;
  onClose: () => void;
  receitaToDelete: ReceitaVariavel | null;
}
    ...
    >
      <div className="mt-2">
        <p className="text-sm text-gray-500">
          Tem certeza que deseja excluir a receita variável <span className="font-semibold text-gray-800">{receitaToDelete?.descricao}</span>?
